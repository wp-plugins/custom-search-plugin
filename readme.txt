...
This plugin allows you to extend search functionality at your website by adding a custom post type.
...
Go to the Settings page and select custom types which are to be included to the search.
